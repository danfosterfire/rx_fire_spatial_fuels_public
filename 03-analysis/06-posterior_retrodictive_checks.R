...
nrow(litter_posterior)

litter_sim = 
  do.call('bind_rows',
          lapply(X = sample(x = 4*9000, size = 4000, replace = FALSE),
                 FUN = function(draw){
...
litter_mean.training = 
  mean(litter_data$Y)

litter_wMAPE.training = litter_mae.training/litter_mean.training
  

litter_retrodiction1 = 
  litter_sim %>%
  group_by(sample, Y_obs) %>%
...
litter_retrodiction5 = 
  litter_sim %>%
  filter(draw == litter_sim$draw[1]) %>%
  group_by(draw, Y_obs) %>%
  summarise(count = n()) %>%
  ungroup() %>%
  mutate(source = 'obs') %>%
...
ggsave(litter_retrodiction1,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'litter_retrodiction1.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(litter_retrodiction2,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'litter_retrodiction2.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(litter_retrodiction3,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'litter_retrodiction3.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(litter_retrodiction4,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'litter_retrodiction4.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(litter_retrodiction5,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'litter_retrodiction5.png'),
       height = 4, width = 6.5, units = 'in')
...
fwd1h_wMAPE.training = fwd1h_mae.training/fwd1h_mean.training
...
ggsave(fwd1h_retrodiction1,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd1h_retrodiction1.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd1h_retrodiction2,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd1h_retrodiction2.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd1h_retrodiction3,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd1h_retrodiction3.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd1h_retrodiction4,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd1h_retrodictions4.png'))
...
ggsave(fwd1h_retrodiction5,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd1h_retrodiction5.png'),
       height = 4, width = 6.5, units = 'in')
...
fwd10h_mean.training = 
  mean(fwd10h_data$Y)

fwd10h_wMAPE.training = fwd10h_mae.training/fwd10h_mean.training


fwd10h_retrodiction1 = 
  fwd10h_sim %>%
  group_by(sample, Y_obs) %>%
  summarise(y.50 = median(Y_sim),
            y.mean = mean(Y_sim),
...
ggsave(fwd10h_retrodiction1,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd10h_retrodiction1.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd10h_retrodiction2,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd10h_retrodiction2.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd10h_retrodiction3,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd10h_retrodiction3.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd10h_retrodiction4,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd10h_retrodictions4.png'))

fwd10h_retrodiction5 = 
  fwd10h_sim %>%
  filter(draw == 1) %>%
  group_by(draw, Y_obs) %>%
  summarise(count = n()) %>%
...
ggsave(fwd10h_retrodiction5,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd10h_retrodiction5.png'),
       height = 4, width = 6.5, units = 'in')
...
fwd100h_mean.training = 
  mean(fwd100h_data$Y)

fwd100h_wMAPE.training = fwd100h_mae.training/fwd100h_mean.training


fwd100h_retrodiction1 = 
  fwd100h_sim %>%
  group_by(sample, Y_obs) %>%
  summarise(y.50 = median(Y_sim),
            y.mean = mean(Y_sim),
...
ggsave(fwd100h_retrodiction1,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd100h_retrodiction1.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd100h_retrodiction2,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd100h_retrodiction2.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd100h_retrodiction3,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd100h_retrodiction3.png'),
       height = 4, width = 6.5, units = 'in')

ggsave(fwd100h_retrodiction4,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd100h_retrodictions4.png'))

fwd100h_retrodiction5 = 
  fwd100h_sim %>%
  filter(draw == 1) %>%
  group_by(draw, Y_obs) %>%
  summarise(count = n()) %>%
...
ggsave(fwd100h_retrodiction5,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'fwd100h_retrodiction5.png'),
       height = 4, width = 6.5, units = 'in')
...
retrodiction_summary_stats = 
  c(litter_mae.training,
    litter_mean.training,
    litter_wMAPE.training,
       fwd1h_mae.training,
       fwd1h_mean.training,
       fwd1h_wMAPE.training,
       fwd10h_mae.training,
       fwd10h_mean.training,
       fwd10h_wMAPE.training,
       fwd100h_mae.training,
       fwd100h_mean.training,
       fwd100h_wMAPE.training)

saveRDS(retrodiction_summary_stats,
